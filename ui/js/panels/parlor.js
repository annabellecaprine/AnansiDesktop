...
CRITICAL: Respond ONLY with valid JSON:
{
  ...
  // ============================================
  function createActorFromParlor(name, personality, appearance, gender, extraNotes) {
              ...
              actions: [
                { label: 'Cancel', class: 'btn-secondary', onclick: () => true },
                {
                  ...
                  onclick: () => {
                    ...
                    createActorFromParlor(name, personality, appearance, gender, 'Generated by The Spider\'s Parlor');
                    if (companionName) {
                      createActorFromParlor(companionName, companionPersonality, companionAppearance, 'any', `Companion of ${name}`);
                    }
                    A.State.notify();
